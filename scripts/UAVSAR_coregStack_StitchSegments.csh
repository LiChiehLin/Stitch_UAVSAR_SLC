...
if ($#argv != 3) then
  ...
  echo ""
  echo "-Stitching SLCs requires modification of .vrt and .xml files"
  echo " template xml and vrt files will be downloaded from the GitHub repository:"
  echo "   URL: https://github.com/LiChiehLin/Stitch_UAVSAR_SLC/tree/main/templates"
  echo ""
